...
<asp:Content ContentPlaceHolderID="phMain" ID="MainContent" runat="server">
	...
	<asp:RegularExpressionValidator ID="regexAvatarFile" ControlToValidate="uploader" Display="Dynamic" EnableClientScript="True" runat="server" ValidationGroup="avatar" />
</asp:Content>
