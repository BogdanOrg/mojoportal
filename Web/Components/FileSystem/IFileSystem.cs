 ...
 */
//  Based on QtFile, Forked/Refactored
...
public interface IFileSystem
{
	...
	/// </summary>
	/// <param name="srcVirtualPath">
	/// The related path of the source folder.
	/// </param>
	/// <param name="destVirtualPath">
	/// The related path of the destination folder.
	/// </param>
	/// <returns>
	/// One of following results:
	...
	/// </list>
	/// </returns>
	//OpResult CopyFolder(string sourceVirtualPath, string targetVirtualPath, bool overwrite);
