...
public class SecurityAdvisor
{
	...
	public (bool userExists, bool passwordIsDefault, int? userId) DefaultAdmin()
	{
		...
		return (true, defaultAdminUser.Password == defaultPassword || defaultAdminUser.Password == encodedPassword, defaultAdminUser.UserId);
	}
