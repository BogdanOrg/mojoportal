...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	...
	<asp:Panel ID="pnlPassword" runat="server" CssClass="panelwrapper login">
		<div class="modulecontent">
			<fieldset>
				<legend>
					<mp:SiteLabel ID="lblRegisterLabel" runat="server" ConfigKey="ChangePasswordLabel" UseLabelTag="false"/>
				</legend>
					...
					<ChangePasswordTemplate>
						<div>
							<asp:Panel ID="divCurrentPassword" runat="server" class="settingrow">
								<strong>
									<mp:SiteLabel ID="lbloldpwd" runat="server" ForControl="CurrentPassword" ConfigKey="ChangePasswordCurrentPasswordLabel"/>
								</strong>
								<br />
