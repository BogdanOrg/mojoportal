...
namespace mojoPortal.Web
{
    ...
    public class ArtisteerTreeViewAdapter : System.Web.UI.WebControls.Adapters.HierarchicalDataBoundControlAdapter, IPostBackEventHandler, IPostBackDataHandler
    {
        ...
        public ArtisteerTreeViewAdapter()
        {
            if (_viewState == null)
            {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (atv != null) { useMenuTooltipForCustomCss = atv.UseMenuTooltipForCustomCss; }
            ...
            HtmlTextWriter writer)
        {
            if (items.Count > 0)
            {
                ...
                {
                    string classname = GetNodeClass(currentItem);
        ...
        private void BuildItem(TreeNode item, HtmlTextWriter writer)
        {
            ...
            if ((treeView != null) && (item != null) && (writer != null))
            {
                ...
                string nodeClass = GetNodeClass(item);
                ...
                {
                    WriteNodeLink(treeView, item, writer, nodeClass);
                }
                else
                {
