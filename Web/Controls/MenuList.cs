...
public class MenuList : List<mojoMenuItem>
{
	...
	private mojoMenuItem GetMenuItemFromNode(mojoSiteMapNode mojoNode)
	{
		return new mojoMenuItem
		{
			...
			Description = Global.SkinConfig.Menu.UseDescriptions ? mojoNode.MenuDescription : string.Empty,
			ShowDescription = Global.SkinConfig.Menu.UseDescriptions && !string.IsNullOrWhiteSpace(mojoNode.MenuDescription),
			Image = Global.SkinConfig.Menu.UseImages ? mojoNode.MenuImage : string.Empty,
			ShowImage = Global.SkinConfig.Menu.UseImages && !string.IsNullOrWhiteSpace(mojoNode.MenuImage),
