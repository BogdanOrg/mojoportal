...
public partial class SiteStatisticsModule : SiteModuleControl
{
	...
	protected override void OnInit(EventArgs e)
	{
		...
		zgMembershipGrowth.RenderGraph += new ZedGraph.Web.ZedGraphWebControlEventHandler(OnRenderUserChart);
		zgMembershipGrowth.RenderedImagePath = $"~/Data/Sites/{siteSettings.SiteId.ToInvariantString()}/systemfiles/";
	}
	...
	private void LoadSettings()
	{
		...
		if (!Request.IsAuthenticated && !WebConfigSettings.AllowAnonymousUsersToViewMemberList)
		{
