...
<asp:HyperLink ID="lnkCustomerReport" runat="server" NavigateUrl="~/Admin/SalesSummary.aspx" /><portal:AdminCrumbSeparator id="AdminCrumbSeparator3" runat="server" Text="&nbsp;&gt;" EnableViewState="false" />
