...
// we need serializable attribute is for AppFabricCache
...
public class SiteSettings
{
	...
	private string editorProviderName = "CKEditorProvider";// CKEditorProvider or TinyMCEProvider
	private ContentEditorSkin editorSkin = ContentEditorSkin.normal;
	private FriendlyUrlPattern defaultFriendlyUrlPattern = FriendlyUrlPattern.PageName;

	// LDAP Settings
	private bool useLdapAuth = false;
	private bool autoCreateLDAPUserOnFirstLogin = true;
	private LdapSettings ldapSettings = new();
	...
	/// For example we want to force urls with hostname mojoportal.com to www.mojoportal.com,
	/// for better SEO
	/// </summary>
