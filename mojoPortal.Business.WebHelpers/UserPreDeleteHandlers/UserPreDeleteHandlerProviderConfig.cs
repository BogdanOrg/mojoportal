...
{
    public class UserPreDeleteHandlerProviderConfig
    {
        private static readonly ILog log
            = LogManager.GetLogger(typeof(UserPreDeleteHandlerProviderConfig));
        ...
        public static UserPreDeleteHandlerProviderConfig GetConfig()
        {
            try
            {
                if (
                    (HttpRuntime.Cache["UserPreDeleteHandlerProviderConfig"] != null)
                    && (HttpRuntime.Cache["UserPreDeleteHandlerProviderConfig"] is UserPreDeleteHandlerProviderConfig)
                )
                {
                    return (UserPreDeleteHandlerProviderConfig)HttpRuntime.Cache["UserPreDeleteHandlerProviderConfig"];
                }

                UserPreDeleteHandlerProviderConfig config
                    = new UserPreDeleteHandlerProviderConfig();

                String configFolderName = "~/Setup/ProviderConfig/userpredeletehandlers/";
