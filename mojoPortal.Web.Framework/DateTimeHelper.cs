...
//TODO: research if this is up-to-date, is it still needed?
...
public static class DateTimeHelper
{
	...
	public static List<TimeZoneInfo> GetTimeZoneList()
	{
		...
		[
			TimeZoneInfo.FromSerializedString(AfghanistanStandardTime),
			TimeZoneInfo.FromSerializedString(AlaskanStandardTime),
			TimeZoneInfo.FromSerializedString(ArabianStandardTime),
			TimeZoneInfo.FromSerializedString(ArabicStandardTime),
			TimeZoneInfo.FromSerializedString(ArabStandardTime),
			TimeZoneInfo.FromSerializedString(ArgentinaStandardTime),
			TimeZoneInfo.FromSerializedString(AtlanticStandardTime),
			TimeZoneInfo.FromSerializedString(AUSCentralStandardTime),
			TimeZoneInfo.FromSerializedString(AUSEasternStandardTime),
			TimeZoneInfo.FromSerializedString(AzerbaijanStandardTime),
			TimeZoneInfo.FromSerializedString(AzoresStandardTime),
			TimeZoneInfo.FromSerializedString(CanadaCentralStandardTime),
			TimeZoneInfo.FromSerializedString(CapeVerdeStandardTime),
			TimeZoneInfo.FromSerializedString(CaucasusStandardTime),
			TimeZoneInfo.FromSerializedString(CenAustraliaStandardTime),
			TimeZoneInfo.FromSerializedString(CentralAmericaStandardTime),
			TimeZoneInfo.FromSerializedString(CentralAsiaStandardTime),
			TimeZoneInfo.FromSerializedString(CentralBrazilianStandard),
			TimeZoneInfo.FromSerializedString(CentralEuropeanStandardTime),
			TimeZoneInfo.FromSerializedString(CentralEuropeStandardTime),
			TimeZoneInfo.FromSerializedString(CentralPacificStandardTime),
			TimeZoneInfo.FromSerializedString(CentralStandardTime),
			TimeZoneInfo.FromSerializedString(CentralStandardTimeMexico),
			TimeZoneInfo.FromSerializedString(ChinaStandardTime),
			TimeZoneInfo.FromSerializedString(DatelineStandardTime),
			TimeZoneInfo.FromSerializedString(EAfricaStandardTime),
			TimeZoneInfo.FromSerializedString(EAustraliaStandardTime),
			TimeZoneInfo.FromSerializedString(EEuropeStandardTime),
			TimeZoneInfo.FromSerializedString(ESouthAmericaStandardTime),
			TimeZoneInfo.FromSerializedString(EasternStandardTime),
			TimeZoneInfo.FromSerializedString(EgyptStandardTime),
			TimeZoneInfo.FromSerializedString(EkaterinburgStandardTime),
			TimeZoneInfo.FromSerializedString(FijiStandardTime),
			TimeZoneInfo.FromSerializedString(FLEStandardTime),
			TimeZoneInfo.FromSerializedString(GeorgianStandardTime),
			TimeZoneInfo.FromSerializedString(GMTStandardTime),
			TimeZoneInfo.FromSerializedString(GreenlandStandardTime),
			TimeZoneInfo.FromSerializedString(GreenwichStandardTime),
			TimeZoneInfo.FromSerializedString(GTBStandardTime),
			TimeZoneInfo.FromSerializedString(HawaiianStandardTime),
			TimeZoneInfo.FromSerializedString(IndiaStandardTime),
			TimeZoneInfo.FromSerializedString(IranStandardTime),
			TimeZoneInfo.FromSerializedString(IsraelStandardTime),
			TimeZoneInfo.FromSerializedString(JordanStandardTime),
			TimeZoneInfo.FromSerializedString(KoreaStandardTime),
			TimeZoneInfo.FromSerializedString(MauritiusStandardTime),
			TimeZoneInfo.FromSerializedString(MidAtlanticStandardTime),
			TimeZoneInfo.FromSerializedString(MiddleEastStandardTime),
			TimeZoneInfo.FromSerializedString(MontevideoStandardTime),
			TimeZoneInfo.FromSerializedString(MoroccoStandardTime),
			TimeZoneInfo.FromSerializedString(MountainStandardTime),
			TimeZoneInfo.FromSerializedString(MountainStandardTimeMexico),
			TimeZoneInfo.FromSerializedString(MyanmarStandardTime),
			TimeZoneInfo.FromSerializedString(NCentralAsiaStandardTime),
			TimeZoneInfo.FromSerializedString(NamibiaStandardTime),
			TimeZoneInfo.FromSerializedString(NepalStandardTime),
			TimeZoneInfo.FromSerializedString(NewfoundlandStandardTime),
			TimeZoneInfo.FromSerializedString(NewZealandStandardTime),
			TimeZoneInfo.FromSerializedString(NorthAsiaEastStandardTime),
			TimeZoneInfo.FromSerializedString(NorthAsiaStandardTime),
			TimeZoneInfo.FromSerializedString(PacificSAStandardTime),
			TimeZoneInfo.FromSerializedString(PacificStandardTime),
			TimeZoneInfo.FromSerializedString(PacificStandardTimeMexico),
			TimeZoneInfo.FromSerializedString(PakistanStandardTime),
			TimeZoneInfo.FromSerializedString(RomanceStandardTime),
			TimeZoneInfo.FromSerializedString(RussianStandardTime),
			TimeZoneInfo.FromSerializedString(SAEasternStandardTime),
			TimeZoneInfo.FromSerializedString(SamoaStandardTime),
			TimeZoneInfo.FromSerializedString(SAPacificStandardTime),
			TimeZoneInfo.FromSerializedString(SAWesternStandardTime),
			TimeZoneInfo.FromSerializedString(SEAsiaStandardTime),
			TimeZoneInfo.FromSerializedString(SingaporeStandardTime),
			TimeZoneInfo.FromSerializedString(SouthAfricaStandardTime),
			TimeZoneInfo.FromSerializedString(SriLankaStandardTime),
			TimeZoneInfo.FromSerializedString(TaipeiStandardTime),
			TimeZoneInfo.FromSerializedString(TasmaniaStandardTime),
			TimeZoneInfo.FromSerializedString(TokyoStandardTime),
			TimeZoneInfo.FromSerializedString(TongaStandardTime),
			TimeZoneInfo.FromSerializedString(USEasternStandardTime),
			TimeZoneInfo.FromSerializedString(USMountainStandardTime),
			TimeZoneInfo.FromSerializedString(VenezuelaStandardTime),
			TimeZoneInfo.FromSerializedString(VladivostokStandardTime),
			TimeZoneInfo.FromSerializedString(WAustraliaStandardTime),
			TimeZoneInfo.FromSerializedString(WCentralAfricaStandardTime),
			TimeZoneInfo.FromSerializedString(WEuropeStandardTime),
			TimeZoneInfo.FromSerializedString(WestAsiaStandardTime),
			TimeZoneInfo.FromSerializedString(WestPacificStandardTime),
			TimeZoneInfo.FromSerializedString(YakutskStandardTime),
		];
