		...
		public static int UserCount(int siteId, string nameBeginsWith, string nameFilterMode)
		{
			switch (nameFilterMode)
			{
				...
				default:
					...
					sph.DefineSqlParameter("@SiteID", SqlDbType.Int, ParameterDirection.Input, siteId);
					sph.DefineSqlParameter("@BeginsWith", SqlDbType.NVarChar, 50, ParameterDirection.Input, nameBeginsWith);
				...
				case "lastname":
					...
					sph2.DefineSqlParameter("@BeginsWith", SqlDbType.NVarChar, 50, ParameterDirection.Input, nameBeginsWith);
