...
{
    public partial class ForumListAlt : UserControl
    {
        #region Properties
        ...
        private void LoadSettings()
        {
            ...
            divEditSubscriptions.Visible = Page.Request.IsAuthenticated;
            lnkModuleRSS.Visible = config.EnableRSSAtModuleLevel && !displaySettings.HideFeedLinks;
            ...
            divSubscribeButtons.Visible = showSubscribeCheckboxes;
